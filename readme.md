...
$$
\begin{array}{c}A U C=\frac{\sum I\left(P_{\text {positive }}, P_{\text {negtive }}\right)}{M \times N} \\I\left(P_{\text {positive }}, P_{\text {negtive }}\right)=\left\{\begin{array}{l}1, P_{\text {positive }}>P_{\text {negtive }} \\0.5, P_{\text {positice }}=P_{\text {negtive }} \\0, P_{\text {positive }}<P_{\text {negtive }}\end{array}\right.\end{array}
$$
